...
// Functions to search for ingredients and meal details
...
function showMealDetailsPopup(meal) {
    mealDetailsContent.innerHTML = `
        ...
        <div class="recipe-video">
            <a href="${meal.Youtube}" target="_blank">Video Tutorial</a>
        </div>`;
...
// Key pressed event in search field
